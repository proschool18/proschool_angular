...
export class DashboardComponent implements OnInit {
  ...
  getClassTeacher_section(class_id) {
    ...
    this.service.getClassTeacher_section(this.selected_class)
      .subscribe(
        res => { this.sections = res.class_sections, this.selected_section = res.class_sections[0].section_id, this.getClassAttendance(), this.getStudentsEvaluation(), console.log(res) }
      )
  }
  ...
  getmonthlyEmployeeAttendance() {
    ...
    if(this.month === 'all') {
      ...
      this.selected_month = parseInt(this.selected_month)
  ...
  getStudentsEvaluation() {
    this.allservice.getEvaluationChart(this.selected_section)
    .subscribe(
      res => { this.studentsEvaluation = res.students, this.viewAcademics(), console.log(this.studentsEvaluation) }
    )
  }
